...
const { omit } = require('../../../utilities/utilities');
const RuleEvaluator = require('@vivintsolar/rule-evaluator');
...
module.exports = (function(){
  ...
  const associationTree = new RuleEvaluator.AssociationTree( { items: documents });
