...
const getAppliedConditions = ( statements, dataType, allowableConditions ) => {
    let appliedConditions = null;
    statements.map( statement => {
        if( dataType === 'formula' && allowableConditions && allowableConditions !== 'none' ){
            allowableConditions.map( id => {
                if( statement.value.includes( id ) ){
