...
const getEvaluatedRulesByTag = require('./getters/getEvaluatedRulesByTag');
...
class AppliedRules extends Definitions {
    constructor( parameters, options, performance ){
        super( parameters );
        ...
        this.initializeAppliedRules( parameters, options, performance );
    }
    clearConditions(){
...
AppliedRules.prototype.getEvaluatedRulesByTag = getEvaluatedRulesByTag;
