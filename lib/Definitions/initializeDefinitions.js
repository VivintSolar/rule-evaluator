        ...
        this.rules = Object.assign({},
            ...Object.values( rules ).map( ruleDefinition => {
                ...
                if( ruleDefinition.condition ){
                    const ruleConditionDefinitionClass = new RuleConditionDefinition( buildDefinitionParameters(ruleDefinition) );
                    this.byId[ ruleDefinition.id ] = ruleConditionDefinitionClass;
                    definitionClass = ruleConditionDefinitionClass
                } else {
                    const ruleDefinitionClass = new RuleDefinition( buildDefinitionParameters(ruleDefinition) );
        ...
        this.conditions = Object.assign({},
            ...Object.values( conditions ).map( conditionDefinition => {
                ...
                if( conditionDefinition.rule ){
                    const ruleConditionDefinitionClass = new RuleConditionDefinition( buildDefinitionParameters(conditionDefinition) );
                    this.byId[ conditionDefinition.id ] = ruleConditionDefinitionClass;
                    definitionClass = ruleConditionDefinitionClass
                } else {
                    const conditionDefinitionClass = new ConditionDefinition( buildDefinitionParameters(conditionDefinition) );
