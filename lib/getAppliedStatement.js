...
module.exports = (function( conditions, valueAccessor ){
    ...
    const getStatement = {
        object: (function(){
            return valueAccessor ? statements.filter( ({ value }) => value[ valueAccessor ] !== undefined )[ 0 ] : null
        }),
        default: (function(){
            return valueAccessor ? statements.filter( ({ value }) => valueAccessor === value )[ 0 ] : statements[ 0 ] || null
        })
    };
