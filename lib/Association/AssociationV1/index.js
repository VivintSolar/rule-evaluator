...
class AssociationV1 extends AppliedRules {
    constructor( parameters, options, performance ){
        ...
        const { ahj, definitions, conditions, options: associationOptions, timeStamp } = associationObject;
        const { rules } = ahj||{};
        super({ rules, definitions, conditions, options:associationOptions, apiVersion }, options, performance );
